...
def train(model, train_loader, val_loader, device, epochs, criterion, optimizer, scheduler=None, save_history_path="history/smart_nir_classification.json", save_fig_path="history/plot.png", save_best_model_path="pretrained/smart_nir_classification_1.pth"):
    best_acc = 0.0
    history = {
        "train_loss": [], 
        "val_loss": [], 
...
if __name__ == "__main__":
    ...
    epochs = 200
    train_ds = ClassificationNIRSDataset("data/classification_data/dataset_1/train", mode="train")
    val_ds = ClassificationNIRSDataset("data/classification_data/dataset_1/val", mode="val")
